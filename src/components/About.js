...
export const About = ()=>{
    ...
    <><div>
            ...
            <p style={{ color: "#961e1b", marginTop: "70px", marginLeft: "70px", textAlign: "left" }}>About eRaktKosh</p>
            <hr
                style={{
                    color: "black",
                    height: 5
        ...
        <h1 style={{marginTop:"20px"}}>e-RaktKosh: A Blood Bank Management System</h1>
        
            </Container>
            
            <Container style={{ backgroundColor: "white" }} className="info1">
            <p className='para' style={{marginTop:"40px",textAlign:"justify"}} >
            e-Rakt Kosh enforces Drug & Cosmetic Act, National blood policy standards and guidelines ensuring proper collection & donation, effective management 
         ...
         <div className="row well">
			<div className="col-sm-6 " style={{marginLeft:"130px"}}>
                       <h4>
							<u>Objectives</u>
						</h4>
					
                    <ul >
					<li >Safe and Adequate Blood
						Supplies</li>
					<li >Reduced Turnaround Time</li>
					<li >Preventing Wastage of Blood
					</li>
					<li >Restrict Professional Donors
					</li>
			...
			<p  style={{fontSize:"20px"}}>
				<b>e-Rakt Kosh has six major components for management of the
